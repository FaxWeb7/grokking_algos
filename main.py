...
Динамическое програмиирование - это способ решения сложных задач путём разбиения их на более простые подзадачи. Оно применяется для оптимизации какой-либо характеристики при заданных ограничениях.
Динамическое программирование работает только в тех ситуациях, в которых задача может быть разбита на автономные прдзадачи, не зависящие друг от друга
"""
...
""" -------------- ГЛАВА 11. ЧТО ДАЛЬШЕ? --------------
Бинарное дерево — иерархическая структура данных, в которой каждый узел имеет не более двух потомков. Как правило, первый называется родительским узлом, а дети называются левым и правым наследниками. Левый наследник меньше родителя по значению, а правый - больше (см. картинку)
